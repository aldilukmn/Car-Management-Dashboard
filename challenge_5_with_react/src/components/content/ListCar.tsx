      ...
      <div className="d-flex flex-column w-100">
        <section className="flex-grow-1 mx-4 mt-4">
          ...
          <div className="d-flex gap-3 active-list-3">
            <button
              className={`btn btn-light rounded-1 border-primary-1 ${
                selectFilter === null ? "border-primary-1-active" : ""
              }`}
            ...
            <button
              className={`btn btn-light rounded-1 border-primary-1 ${
                selectFilter === "small" ? "border-primary-1-active" : ""
              }`}
            ...
            <button
              className={`btn btn-light rounded-1 border-primary-1 ${
                selectFilter === "medium" ? "border-primary-1-active" : ""
              }`}
            ...
            <button
              className={`btn btn-light rounded-1 border-primary-1 ${
                selectFilter === "large" ? "border-primary-1-active" : ""
              }`}
